      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#8f93b6</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
        ...
        <se:Rule>
          <se:TextSymbolizer>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#002b91</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.891</se:SvgParameter>
            </se:Fill>
